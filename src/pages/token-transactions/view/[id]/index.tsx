...
import { getTokenTransactionById } from 'apiSdk/token-transactions';
...
function TokenTransactionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Token Transaction Detail View
          </Text>
          {hasAccess('token_transaction', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/token-transactions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
